    ...
    <body class="theme-color-dark">
        ...
        %>
            ...
            <div class="project-edit">
                <form method="post" action="EditProjectHandler.jsp?projectId=<%=projectId%>">
                    <div>
                        <div class="form-group">
                            <label for="inputTitle">Project Title (max 70 characters):</label>
                            <input type="text" class="form-control" id="inputTitle" name="title" value="<%=project.getTitle()%>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputBudget" name="budget" value="<%=project.getBudget()%>">
                        </div>
                        <div class="form-group">
                            <label for="inputDescription">Description (max 1000 characters):</label>
                            <textarea rows=10 type="text" class="form-control" id="inputDescription" name="description"><%=project.getDescr()%></textarea>
                        </div>
                    ...
                    <%  if (user.getType().equals("Customer")) { %>
                        <div>
                            <div class="form-group">            
                                ...
                                <button type="reset" class="btn btn-white btn-undo">
